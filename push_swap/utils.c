...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/14 23:24:55 by merboyac          #+#    #+#             */
/*   Updated: 2024/01/24 11:12:24 by merboyac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (i < size)
	{
		while (j < size)
		{
			if (stack ->a[i] == stack ->a[j])
				return (ft_free_argv(argv, stack, check), exit(0));
			j++;
		}
		i++;
		j = i + 1;
